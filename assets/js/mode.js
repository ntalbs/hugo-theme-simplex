...
function monokai () {
  ...
  root.style.setProperty('--CommentHashbang', '#ccc')
  root.style.setProperty('--CommentMultiline', '#aaa')
  root.style.setProperty('--CommentSingle', '#aaa')
  root.style.setProperty('--CommentSpecial', '#aaa')
  root.style.setProperty('--CommentPreproc', '#ccc')
  root.style.setProperty('--CommentPreprocFile', '#aaa')
